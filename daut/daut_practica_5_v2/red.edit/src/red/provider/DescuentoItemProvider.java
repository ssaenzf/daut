...
public class DescuentoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Descuento_horaApertura_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Descuento_horaApertura_feature", "_UI_Descuento_type"),
				 RedPackage.Literals.DESCUENTO__HORA_APERTURA,
				 true,
				 false,
				 false,
	...
	protected void addHoraCierrePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Descuento_horaCierre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Descuento_horaCierre_feature", "_UI_Descuento_type"),
				 RedPackage.Literals.DESCUENTO__HORA_CIERRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Descuento_type") + " " + descuento.getHoraApertura();
	}

...
public class RedItemProviderAdapterFactory extends RedAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link red.Parada} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ParadaItemProvider paradaItemProvider;

	/**
	 * This creates an adapter for a {@link red.Parada}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createParadaAdapter() {
		if (paradaItemProvider == null) {
			paradaItemProvider = new ParadaItemProvider(this);
		}

		return paradaItemProvider;
	}
	...
	public void dispose() {
		...
		if (paradaItemProvider != null) paradaItemProvider.dispose();

						...
						try {
							...
							while (true) {
								...
								try {
									...
									try {
										final /*@Thrown*/ IntegerValue indexOf = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas, parada1);
										final /*@Thrown*/ IntegerValue indexOf_0 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas, parada2);
										if (indexOf_0 == null) {
									...
									if (CAUGHT_eq == ValueUtil.FALSE_VALUE) {
										...
										try {
											...
											try {
												if (parada1 == null) {
													throw new InvalidValueException("Null source for \'\'red\'::Parada::zonatarificacion\'");
												}
												final /*@Thrown*/ ZonaTarifacion zonatarificacion = parada1.getZonatarificacion();
												final /*@Thrown*/ int enumeracion = zonatarificacion.getEnumeracion();
												if (parada2 == null) {
													throw new InvalidValueException("Null source for \'\'red\'::Parada::zonatarificacion\'");
												}
												final /*@Thrown*/ ZonaTarifacion zonatarificacion_0 = parada2.getZonatarificacion();
												final /*@Thrown*/ int enumeracion_0 = zonatarificacion_0.getEnumeracion();
												final /*@Thrown*/ boolean eq_0 = enumeracion == enumeracion_0;
												CAUGHT_eq_0 = eq_0;
											}
											catch (Exception e) {
											...
											if (CAUGHT_eq_0 == ValueUtil.TRUE_VALUE) {
												...
												try {
													...
													final /*@Thrown*/ ZonaTarifacion zonatarificacion_1 = parada1.getZonatarificacion();
													final /*@Thrown*/ int enumeracion_1 = zonatarificacion_1.getEnumeracion();
													final /*@Thrown*/ IntegerValue BOXED_enumeracion_1 = ValueUtil.integerValueOf(enumeracion_1);
													if (parada2 == null) {
														throw new InvalidValueException("Null source for \'\'red\'::Parada::zonatarificacion\'");
													}
													final /*@Thrown*/ ZonaTarifacion zonatarificacion_2 = parada2.getZonatarificacion();
													final /*@Thrown*/ int enumeracion_2 = zonatarificacion_2.getEnumeracion();
													final /*@Thrown*/ IntegerValue BOXED_enumeracion_2 = ValueUtil.integerValueOf(enumeracion_2);
													final /*@Thrown*/ IntegerValue sum_0 = (IntegerValue)NumericPlusOperation.INSTANCE.evaluate(BOXED_enumeracion_2, RedTables.INT_1);
													final /*@Thrown*/ boolean eq_1 = BOXED_enumeracion_1.equals(sum_0);
													CAUGHT_eq_1 = eq_1;
												}
												catch (Exception e) {

...
public class RedTransporteImpl extends MinimalEObjectImpl.Container implements RedTransporte {
	...
	public boolean lineasParadasConsecutivasIguales(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 *             linea2.paradas->forAll(par2 | par1 = par2 and
			 *               linea1.paradas->at(1 + linea1.paradas->indexOf(par1)) =
			 *               linea2.paradas->at(1 + linea2.paradas->indexOf(par2)) implies
									...
									try {
										...
										while (true) {
											...
											try {
												/*@Caught*/ Object CAUGHT_and;
												try {
													final /*@NonInvalid*/ boolean eq = (par1 != null) ? par1.equals(par2) : (par2 == null);
													final /*@Thrown*/ Boolean and;
													if (!eq) {
														and = ValueUtil.FALSE_VALUE;
													}
														...
														try {
															final /*@Thrown*/ IntegerValue indexOf = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas, par1);
															if (indexOf == null) {
																throw new InvalidValueException("Null \'\'OclSelf\'\' rather than \'\'OclVoid\'\' value required");
															}
															if (indexOf instanceof InvalidValueException) {
																throw (InvalidValueException)indexOf;
															}
															final /*@Thrown*/ IntegerValue sum = (IntegerValue)NumericPlusOperation.INSTANCE.evaluate(RedTables.INT_1, indexOf);
															if (sum instanceof InvalidValueException) {
																throw (InvalidValueException)sum;
															}
															final /*@Thrown*/ Parada at = (Parada)OrderedCollectionAtOperation.INSTANCE.evaluate(BOXED_paradas, sum);
															final /*@Thrown*/ IntegerValue indexOf_0 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas_0, par2);
															if (indexOf_0 == null) {
																throw new InvalidValueException("Null \'\'OclSelf\'\' rather than \'\'OclVoid\'\' value required");
															}
															...
															final /*@Thrown*/ IntegerValue sum_0 = (IntegerValue)NumericPlusOperation.INSTANCE.evaluate(RedTables.INT_1, indexOf_0);
															if (sum_0 instanceof InvalidValueException) {
																throw (InvalidValueException)sum_0;
															}
															final /*@Thrown*/ Parada at_0 = (Parada)OrderedCollectionAtOperation.INSTANCE.evaluate(BOXED_paradas_0, sum_0);
															final /*@Thrown*/ boolean eq_0 = (at != null) ? at.equals(at_0) : (at_0 == null);
															CAUGHT_eq_0 = eq_0;
														}
														catch (Exception e) {
												...
												if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
													...
													try {
														...
														while (true) {
															...
															try {
																final /*@Thrown*/ List<Double> siguienteParadaDistancia_0 = local_1.getSiguienteParadaDistancia();
																final /*@Thrown*/ OrderedSetValue BOXED_siguienteParadaDistancia_0 = idResolver.createOrderedSetOfAll(RedTables.ORD_DATAid_EDouble, siguienteParadaDistancia_0);
																/*@Thrown*/ Object accumulator_2 = ValueUtil.TRUE_VALUE;
																Iterator<Object> ITERATOR_dis2 = BOXED_siguienteParadaDistancia_0.iterator();
																...
																while (true) {
																	...
																	try {
																		...
																		try {
																			...
																			try {
																				final /*@Thrown*/ IntegerValue indexOf_1 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_siguienteParadaDistancia, dis1);
																				final /*@Thrown*/ IntegerValue indexOf_2 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas, par1);
																				final /*@Thrown*/ boolean eq_1 = (indexOf_1 != null) ? indexOf_1.equals(indexOf_2) : (indexOf_2 == null);
																				CAUGHT_eq_1 = eq_1;
																			}
																			catch (Exception e) {
																			...
																			if (CAUGHT_eq_1 == ValueUtil.FALSE_VALUE) {
																				...
																				try {
																					final /*@Thrown*/ IntegerValue indexOf_3 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_siguienteParadaDistancia_0, dis2);
																					final /*@Thrown*/ IntegerValue indexOf_4 = OrderedCollectionIndexOfOperation.INSTANCE.evaluate(BOXED_paradas_0, par2);
																					final /*@Thrown*/ boolean eq_2 = (indexOf_3 != null) ? indexOf_3.equals(indexOf_4) : (indexOf_4 == null);
																					CAUGHT_eq_2 = eq_2;
																				}
																				catch (Exception e) {
																		...
																		if (CAUGHT_and_0 == ValueUtil.FALSE_VALUE) {
																			...
																			final /*@NonInvalid*/ boolean eq_3 = dis1.equals(dis2);
																			if (eq_3) {
																				implies = ValueUtil.TRUE_VALUE;
																			}
																			else {
																	...
																	if (CAUGHT_implies == ValueUtil.FALSE_VALUE) {					// Normal unsuccessful body evaluation result
																		...
																		accumulator_2 = CAUGHT_implies;									// Cache an exception failure
																	}
																	else {															// Impossible badly typed result
											...
											if (CAUGHT_implies_0 == ValueUtil.FALSE_VALUE) {					// Normal unsuccessful body evaluation result
												...
												accumulator_0 = CAUGHT_implies_0;									// Cache an exception failure
											}
											else {															// Impossible badly typed result
												accumulator_0 = new InvalidValueException(PivotMessages.NonBooleanBody, "forAll");
											}

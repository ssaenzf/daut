...
public class DescuentoImpl extends MinimalEObjectImpl.Container implements Descuento {
	 ...
	 * @generated
	 */
	public boolean descuentoCorrecto(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Descuento::descuentoCorrecto";
		try {
			/**
			 *
			 * inv descuentoCorrecto:
			 *   let severity : Integer[1] = constraintName.getSeverity()
			 *   in
			 *     if severity <= 0
			 *     then true
			 *     else
			 *       let result : Boolean[?] = descuento > 0 and descuento <= 100
			 *       in
			 *         constraintName.logDiagnostic(self, null, diagnostics, context, null, severity, result, 0)
			 *     endif
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, RedPackage.Literals.DESCUENTO___DESCUENTO_CORRECTO__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ int descuento_0 = this.getDescuento();
				final /*@NonInvalid*/ IntegerValue BOXED_descuento_0 = ValueUtil.integerValueOf(descuento_0);
				final /*@NonInvalid*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, BOXED_descuento_0, RedTables.INT_0).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (!gt) {
					result = ValueUtil.FALSE_VALUE;
				}
				else {
					final /*@NonInvalid*/ boolean le_0 = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, BOXED_descuento_0, RedTables.INT_100).booleanValue();
					if (!le_0) {
						result = ValueUtil.FALSE_VALUE;
					}
					else {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RedPackage.DESCUENTO___DESCUENTO_CORRECTO__DIAGNOSTICCHAIN_MAP:
				return descuentoCorrecto((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));

	...
	public boolean nonDuplicateNombreParada(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_red_c_c_ParadaTren_0 = idResolver.getClass(RedTables.CLSSid_ParadaTren, null);
				final /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE.evaluate(executor, RedTables.SET_CLSSid_ParadaTren, TYP_red_c_c_ParadaTren_0);

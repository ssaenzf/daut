...
public class CuestionarioParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CuestionarioGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCuestionarioAccess().getGroup_5(), "rule__Cuestionario__Group_5__0");
			builder.put(grammarAccess.getCuestionarioAccess().getGroup_10(), "rule__Cuestionario__Group_10__0");
			...
			builder.put(grammarAccess.getPreguntaUnicaAccess().getGroup_11_2(), "rule__PreguntaUnica__Group_11_2__0");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getGroup_11_4(), "rule__PreguntaUnica__Group_11_4__0");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getGroup_15(), "rule__PreguntaUnica__Group_15__0");
			...
			builder.put(grammarAccess.getPreguntaMultipleAccess().getGroup_11_2(), "rule__PreguntaMultiple__Group_11_2__0");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getGroup_11_4(), "rule__PreguntaMultiple__Group_11_4__0");
			...
			builder.put(grammarAccess.getPreguntaMultipleAccess().getGroup_17_3(), "rule__PreguntaMultiple__Group_17_3__0");
			builder.put(grammarAccess.getRespuestaAccess().getGroup(), "rule__Respuesta__Group__0");
			builder.put(grammarAccess.getCuestionarioAccess().getPreguntasAssignment_4(), "rule__Cuestionario__PreguntasAssignment_4");
			builder.put(grammarAccess.getCuestionarioAccess().getPreguntasAssignment_5_1(), "rule__Cuestionario__PreguntasAssignment_5_1");
			builder.put(grammarAccess.getCuestionarioAccess().getCategoriasAssignment_9(), "rule__Cuestionario__CategoriasAssignment_9");
			builder.put(grammarAccess.getCuestionarioAccess().getCategoriasAssignment_10_1(), "rule__Cuestionario__CategoriasAssignment_10_1");
			builder.put(grammarAccess.getCuestionarioAccess().getPreguntaInicialAssignment_13(), "rule__Cuestionario__PreguntaInicialAssignment_13");
			builder.put(grammarAccess.getCuestionarioAccess().getPreguntasFinalesAssignment_16(), "rule__Cuestionario__PreguntasFinalesAssignment_16");
			builder.put(grammarAccess.getCuestionarioAccess().getPreguntasFinalesAssignment_17_1(), "rule__Cuestionario__PreguntasFinalesAssignment_17_1");
			...
			builder.put(grammarAccess.getPreguntaUnicaAccess().getIsInicialAssignment_11_0(), "rule__PreguntaUnica__IsInicialAssignment_11_0");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getSiguientePreguntaAciertoAssignment_11_2_1(), "rule__PreguntaUnica__SiguientePreguntaAciertoAssignment_11_2_1");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getSiguientePreguntaErrorAssignment_11_4_1(), "rule__PreguntaUnica__SiguientePreguntaErrorAssignment_11_4_1");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getRespuestasAssignment_14(), "rule__PreguntaUnica__RespuestasAssignment_14");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getRespuestasAssignment_15_1(), "rule__PreguntaUnica__RespuestasAssignment_15_1");
			builder.put(grammarAccess.getPreguntaUnicaAccess().getCorrectaAssignment_18(), "rule__PreguntaUnica__CorrectaAssignment_18");
			...
			builder.put(grammarAccess.getPreguntaMultipleAccess().getIsInicialAssignment_11_0(), "rule__PreguntaMultiple__IsInicialAssignment_11_0");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getSiguientePreguntaAciertoAssignment_11_2_1(), "rule__PreguntaMultiple__SiguientePreguntaAciertoAssignment_11_2_1");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getSiguientePreguntaErrorAssignment_11_4_1(), "rule__PreguntaMultiple__SiguientePreguntaErrorAssignment_11_4_1");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getRespuestasAssignment_14(), "rule__PreguntaMultiple__RespuestasAssignment_14");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getRespuestasAssignment_15_1(), "rule__PreguntaMultiple__RespuestasAssignment_15_1");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getCorrectasAssignment_17_2(), "rule__PreguntaMultiple__CorrectasAssignment_17_2");
			builder.put(grammarAccess.getPreguntaMultipleAccess().getCorrectasAssignment_17_3_1(), "rule__PreguntaMultiple__CorrectasAssignment_17_3_1");
